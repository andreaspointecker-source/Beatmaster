// BeatMaster - Settings Screen (Placeholder)
      ...
      <div class="flex flex-col h-full min-h-screen w-full">
        <header class="sticky top-0 z-50 bg-background-dark/95 backdrop-blur-md border-b border-white/5">
          <div class="flex items-center p-4 justify-between">
            ...
            <h1 class="text-lg font-bold leading-tight tracking-tight flex-1 text-center">Einstellungen</h1>
            <div class="size-12"></div>
          </div>
        </header>

        <main class="flex-1 flex flex-col items-center justify-center px-6 text-center">
          <span class="material-symbols-outlined text-white/20 mb-4" style="font-size: 64px;">settings</span>
          <h2 class="text-2xl font-bold text-white mb-2">Einstellungen</h2>
